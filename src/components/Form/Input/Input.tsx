...
import { ReactComponent as EyeIcon } from '@/assets/icons/eye-shape.svg';
      ...
      >
        ...
        {props.type === 'number' ? (
          <NumberInput
            ...
            id={props.name || registration?.name}
            className={clsx(
              'block w-full appearance-none rounded-md border bg-transparent font-medium text-gray-800 placeholder-gray-400 transition-colors duration-200 autofill:!bg-white hover:border-blue-400 focus:border-gray-500 focus:outline-none focus:ring-gray-500 dark:text-white',
